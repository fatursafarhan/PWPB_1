<?php
  ...
  if($nama == 'fatur'){
    $nama_lengkap = 'M Fatur safarhan';
    $hobi = 'beatbox';
    $citacita = 'cinematographer';
    $tinggi_badan = 172;
  }elseif($nama == 'risma'){
    $nama_lengkap = 'Risma Astuti';
    $hobi = 'nari';
    $citacita = 'programmer';
    $tinggi_badan = 162;
  }elseif($nama == 'Adel'){
...
<body id="page-top">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item mx-0 mx-lg-1">
            <a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="tugas1.php">Tugas 1</a>
          </li>      
        </ul>
      </div>
    </div>
  ...
  <center>
      <h3 class="page-section-heading text-center text-uppercase text-secondary mb-0">Nama : <?php echo $nama_lengkap ?> <br>
                                                                                      Hobi : <?php echo $hobi ?><br>
                                                                                      Cita-cita: <?php echo $citacita ?><br>
                                                                                      Tinggi badan : <?php echo $tinggi_badan ?>      
      <h3>
  </center 
      ...
      <div class="row">
        ...
        <div class="col-lg-4 mb-5 mb-lg-0">
          ...
          <p class="lead mb-0">SMK Adi Sanggoro
            <br>Kampus Dalam IPB, Jln Sengked No.1, Babakan, Kec. Dramaga, Bogor, Jawa Barat 16680, Indonesia </p>
        </div>
